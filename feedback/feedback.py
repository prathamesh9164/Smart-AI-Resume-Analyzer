...
class FeedbackManager:
    ...
    def render_feedback_form(self):
        ...
        st.markdown('<h2 class="feedback-header">ðŸ“ Share Your Feedback</h2>', unsafe_allow_html=True)
        ...
        st.markdown(f'<div class="rating-container">{"â­" * rating}</div>', unsafe_allow_html=True)
        ...
        st.markdown(f'<div class="rating-container">{"â­" * usability_score}</div>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
        ...
        st.markdown(f'<div class="rating-container">{"â­" * feature_satisfaction}</div>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
        ...
        if st.button("Submit Feedback", key="submit_feedback"):
            try:
                ...
                for i in range(100):
                    ...
                    if i < 30:
                        status_text.text("Processing feedback... ðŸ“")
                    elif i < 60:
                        status_text.text("Analyzing responses... ðŸ”")
                    elif i < 90:
                        status_text.text("Saving to database... ðŸ’¾")
                    else:
                ...
                success_container.markdown("""
                    <div style="text-align: center; padding: 20px; background: linear-gradient(90deg, rgba(76, 175, 80, 0.1), rgba(33, 150, 243, 0.1)); border-radius: 10px;">
                        <h2 style="color: #4CAF50;">Thank You! ðŸŽ‰</h2>
    ...
    def render_feedback_stats(self):
        ...
        st.markdown("""
            <div style="text-align: center; padding: 15px; background: linear-gradient(90deg, rgba(76, 175, 80, 0.1), rgba(33, 150, 243, 0.1)); border-radius: 10px; margin-bottom: 20px;">
                <h3 style="color: #E0E0E0;">Feedback Overview ðŸ“Š</h3>
            </div>
        """, unsafe_allow_html=True)
        ...
        metrics = [
            ...
            {"label": "Usability Score", "value": f"{stats['avg_usability']:.1f}/5.0", "delta": "ðŸŽ¯"},
            {"label": "Satisfaction", "value": f"{stats['avg_satisfaction']:.1f}/5.0", "delta": "ðŸ˜Š"}
        ]
